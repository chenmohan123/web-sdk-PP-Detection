export const zhCN = {
  ...
  fitWindow: "适应窗口",
  resetView: "重置视图",
  zoomHint: "滚轮或双指缩放，拖动查看；导出保留完整图片。",
  targetHint: "点击检测框或结果列表定位目标；点击空白处取消选择。视频可停止后定位。",
  selectedTarget: "已选中",
  clearSelection: "取消选择",
  filterClasses: "筛选类别",
  showAllClasses: "显示全部",
  classFilterHint: "筛选仅影响显示和图片导出；JSON 保留全部检测结果。",
  noMatchingDetections: "当前筛选下无目标，可选择其他类别或显示全部。",
  detections: "个目标",
  box: "框",
  threshold: "置信度阈值",
