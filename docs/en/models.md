...
The repository's PicoDet-L-320 manifest is `models/pp-detection/1.0.1/manifest.json`; its FP32
...
| --------------- | ------------ | -------------------------------------------------------------------------------------- |
| FP32            | stable       | 1.0.1; seven-fixture validation passed on WASM and NVIDIA WebGPU                       |
