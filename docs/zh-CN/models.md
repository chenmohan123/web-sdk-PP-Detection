...
不可变分发来源也已记录 revision、下载地址、大小和 SHA-256；1.0.1 FP32 候选已在
Linux WASM 和 Windows NVIDIA WebGPU 上完成 7 张 fixture 验证，但 FP16、移动端、微信
WebView 及来源许可核验尚未完成，因此它还不是 SDK 默认加载的 stable 变体。使用 SDK 时请传入
