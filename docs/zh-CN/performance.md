...
当前默认组合为 PicoDet-L-320 1.0.2、ModelScope、FP32；PP-YOLOE+ S/M/L/X 0.1.1 与五模型的 FP16/W8A32 也均为 stable。S 与 PicoDet 的性能证据见[原三精度对比](../../reports/evaluation/2026-09-12-precision-variants/README.md)，M/L/X 证据见[本轮质量报告](../../reports/evaluation/2026-09-14-ppyoloe-mlx-release/README.md)，均只覆盖桌面 WASM/WebGPU 固定 64 图三轮验证。体积缩小不代表峰值内存同比下降或推理必然加速；小米 15 实测仅覆盖原 FP32，不能以一次测试或单台设备的耗时代表普遍性能。
