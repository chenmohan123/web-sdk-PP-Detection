...
本例面向微信公众号 H5/WebView 和小程序 web-view，要求 HTTPS、允许模型下载域名和足够内存；不支持微信小程序原生推理。监听 WeixinJSBridgeReady 仅用于宿主就绪提示。尚无真实微信 Android/iOS 设备验证，桌面 Chromium 结果不是微信兼容承诺。
