...
- 输入与预处理：NCHW `1x3x640x640` float32，拉伸到 640 x 640，bicubic 插值，缩放系数 1/255，ImageNet mean/std 归一化。
- 文件：`picodet-l-640-fp32.onnx`，23320381 字节，SHA-256 `bbc0a02f543e49dfcbd50efcd700c99c8183c94e147bb83b7a921a6ec9aaf1df`。
