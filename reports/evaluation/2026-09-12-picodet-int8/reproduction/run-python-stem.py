...
models={name:OUT/'models'/f'{name}.onnx' for name in ['qdq-stem-fp32','qoperator-stem-fp32']}
summary={}
...
(OUT/'python/summary-stem.json').write_text(json.dumps(summary,ensure_ascii=False,indent=2),encoding='utf-8')
