import type { ModelManifest } from "../../packages/sdk/src/types";
...
export const tinyModelManifest: ModelManifest = {
  ...
  model: {
    ...
    id: "pp-detection-tiny",
    modelType: "pp_detection_v3",
    parameterCount: 10,
    version: "1.0.0"
  },
  outputs: [
  ...
  source: {
    ...
    url: "https://github.com/chenmohan123/web-sdk-PP-Detection"
  },
